...
function Profile(props) {
    ...
    axios.interceptors.request.use(
        ...
        const url="http://localhost:9096/washer/profile"
        ...
        function get(){
          ...
          const handleSubmit = e => {
            ...
            axios.put('http://localhost:9096/washer/update',null,{params:{name,gmail,password,location,Username}}).then(
                res => {
                    console.log(res.data)
...
// localStorage.removeItem('token')
          ...
          useEffect(() => {
           ...
           const  deleteaccount=(e)=>{
                ...
                e.preventDefault();
                axios.delete('http://localhost:9096/washer/delete').then(
                    res=>
                    {
                        console.log(res.data)
